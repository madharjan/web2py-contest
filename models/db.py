...
db.vote.contestant_id.requires = IS_IN_DB(db, db.contestant.id, '%(code)s - %(name)s')
#db.vote.contestant_id.writable = False
#db.vote.contestant_id.readable = False
db.vote.ticket_no.requires = IS_NOT_EMPTY()
db.vote.ticket_pin.requires = IS_NOT_EMPTY()
db.vote.voted_datetime.requires = IS_DATETIME()
db.vote.voted_datetime.writable = False
db.vote.voted_datetime.readable = False
